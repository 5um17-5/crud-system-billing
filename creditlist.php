  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="#">Credit list<span class="sr-only">(current)</span></a>
      </li>
...
<div class="container">
  <br>
  <a href="add_credit_bills.php"><button class="btn btn-outline-success btn-sm">Add Credit Bills</button></a> <button class="btn btn-outline-success btn-sm">Check Creditory History</button>
</div>
