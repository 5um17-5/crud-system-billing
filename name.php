  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="#">Name Information <span class="sr-only">(current)</span></a>
      </li>
...
<div class="container">
  ...
  <form class="form-inline my-2 my-sm-0">
      <input class="form-control form-control-sm mr-sm-2" type="search" placeholder="Type Name" aria-label="Search">
      <button class="btn btn-outline-success btn-sm my-2 my-sm-0" type="submit">Find Person</button>
  </form>
  <br>
