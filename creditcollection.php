  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="#">Credit collection<span class="sr-only">(current)</span></a>
      </li>
...
<div class="container">
  <br>
  <a href="add_daily_collection.php"><button class="btn btn-outline-success btn-sm">Add daily collection</button></a> <button class="btn btn-outline-success btn-sm">Calculate collection</button>
</div>
