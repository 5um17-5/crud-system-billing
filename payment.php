...
<div class="container">
  <br>
  <a href="add_payment.php"><button class="btn btn-outline-success btn-sm">Make Payment</button></a> <button class="btn btn-outline-success btn-sm">Check Payment History</button>
</div>
