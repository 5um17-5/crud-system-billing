...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit"><a href="logout.php"><a href="logout.php">Logout</a></a></button>
  </div>
</nav>

<div class="container">
  <br>
  <h2>Welcome to the Store Database</h2>
  <p>
    ESTD. 2060 <br>
